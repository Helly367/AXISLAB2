...
const DeleteConfirm = ({
    ...
    const deleteRender = () => {
        ...
        if (!element || !elementId || !projet_id) {
            alertService.warning("L'élement que vous éssayez de supprimer n'existe pas ou a été corrompu")
            return null;
        }
                    ...
                    <div className="flex flex-col items-center mt-8">
                        ...
                        <div className="flex self-end gap-3 p-4 mt-6">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="flex gap-2 px-4 py-2 text-sm rounded-lg bg-red-600 text-white hover:bg-red-700">
                                {loading ? (
                                    <>
