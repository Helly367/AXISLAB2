...
import { useProjects } from '../../../hooks/useProjets'; // Import du hook

const OpenProject = ({ setProject }) => {
    const [searchTerm, setSearchTerm] = useState('');
    const { projects, loading, selectActiveProject } = useProjects(); // Utilisation du hook

    const handleSelectProject = (project) => {
        selectActiveProject(project); // Sauvegarde dans le contexte
        setProject(project); // Pour la navigation
