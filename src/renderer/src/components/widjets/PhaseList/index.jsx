        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {phases.map((phase) => (
                <div key={phase.id}
                    ...
                    <div className="bg-blue text-white p-3 rounded-lg w-fit mb-4">
                        <Code />
                    </div>
                    ...
                    <div className="mt-auto">
                        <button
                            ...
                            className="w-full bg-blue text-white py-2 rounded-lg hover:bg-blue-700 transition-colors font-medium">
                            Voir la phase
                        </button>
                    </div>
                </div>
