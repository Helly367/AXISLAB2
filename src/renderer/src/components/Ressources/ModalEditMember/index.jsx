...
const ModalEditMember = ({ isOpen, onClose, onSave, memberToEdit }) => {
    ...
    useEffect(() => {
        if (memberToEdit) {
            // Convertir competencesRequises en string pour l'input
            const competencesRequisesString = memberToEdit.competencesRequises?.join(', ') || '';
            ...
            reset({
                ...
                competences: memberToEdit.competences?.length ? memberToEdit.competences : [''],
                competencesRequises: competencesRequisesString
            });
        }
    }, [memberToEdit, reset]);
        ...
        <div className="fixed inset-0 bg-opacity flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="bg-primary p-4 flex justify-between items-center sticky top-0">
                    <h2 className="text-xl text-white font-bold">Modifier le membre</h2>
                    <button
                        onClick={onClose}
