...
import { Close, History, Work } from "@mui/icons-material";
        ...
        <div className="fixed inset-0 bg-opacity flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl">
                ...
                <div className="p-6">
                    ...
                    <div className="bg-purple-50 rounded-lg p-4 mb-6">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-gray-800">{member.poste || "Non défini"}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="font-medium text-gray-800">
                                    {(member.historique || []).filter(Boolean).length}
                                </p>
                            </div>
                    ...
                    {(member.historique || []).filter(Boolean).length > 0 ? (
                        <div className="space-y-4">
                            ...
                            {(member.historique || [])
                                ...
                                .map((item, index) => (
                                    <div
                                        key={index}
                                        className="relative pl-8 pb-4 border-l-2 border-purple-200 last:pb-0">
