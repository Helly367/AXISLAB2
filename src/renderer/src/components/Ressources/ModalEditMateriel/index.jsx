...
const ModalEditMateriel = ({ isOpen, onClose, onSave, materielToEdit, budgetRestant }) => {
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div className="flex justify-between items-center">
                            <span className="font-medium text-blue-800">Budget disponible pour modification:</span>
                    ...
                    {totalEstime > budgetRestant && (
                        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                            <div className="flex items-center gap-2 text-red-700">
                                <Warning />
                                <p className="font-medium">Budget insuffisant pour cette modification !</p>
                            </div>
                        </div>
                    )}
...
export default ModalEditMateriel;